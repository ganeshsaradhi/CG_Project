...
public class UserDAOTest {
	...
	public void testRegisterValid() {
		...
		bean.setPassword("ganesh");
		bean.setMobile(982882888);
	...
	public void testLoginValid() {
		UsersBean info = dao.login("ganesh@gmail.com", "ganesh");
		Assertions.assertNotNull(info);
	}
	
	@Test
	public void testLoginInvalid() {
		UsersBean info = dao.login("ganesh@gmail.com", "ganesh1");
	...
	public void testSearchBookByAuthorValid() {
		List<BookBean> info = dao.searchBookByAuthor("Ramanujan");
		Assertions.assertNotNull(info);
		Assertions.assertEquals(1, info.size());		
	}
